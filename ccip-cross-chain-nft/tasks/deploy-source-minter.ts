...
task(`deploy-source-minter`, `Deploys SourceMinter.sol smart contract`)
    ...
    .setAction(async (taskArguments: TaskArguments, hre: HardhatRuntimeEnvironment) => {
        ...
        const ghoAddress = "0xc4bF5CbDaBE595361438F8c6a187bDc330539c60"; // GHO address on the source blockchain (Sepolia)
        ...
        const sourceMinter: SourceMinter = await hre.ethers.deployContract("SourceMinter", [routerAddress, linkAddress, ghoAddress]);
