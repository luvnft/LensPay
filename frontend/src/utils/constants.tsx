...
export const uiConfig: UiConfig =
  network === "polygon"
    ? {
      ...
      helloWorldContractStartBlock: 52484545,
      openActionContractAddress: "0x7c4fAeef5ba47a437DFBaB57C016c1E706F56fcf",
      openActionContractStartBlock: 52484545,
      ...
      rpc: `https://polygon-mainnet.g.alchemy.com/v2/${import.meta.env.VITE_ALCHEMY_POLYGON_API_KEY
        }`,
    }
    : {
      helloWorldContractAddress: "0xA7f3b059b1931B07A1ECB55350dDbaF614b3cD99",
      helloWorldContractStartBlock: 45006620,
      openActionContractAddress: "0xeE54f5bA1505839F139E29deaD51F7983D70bD87",
      openActionContractStartBlock: 45006620,
      ...
      rpc: `https://polygon-mumbai.g.alchemy.com/v2/${import.meta.env.VITE_ALCHEMY_MUMBAI_API_KEY
        }`,
    };
